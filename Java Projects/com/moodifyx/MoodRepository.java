...
public class MoodRepository{
    ...
    private void initializeMoodSongs(){
        Map<String,String[]> moodfiles=Map.of(
                ...
                "Mysterios",new String[]{"mysteriousgirl.wav","mysteriousgirlie.wav"},
                ...
                "Positive",new String[]{"positivegirl.wav","positvegirlie.wav"}
        );
    ...
    public List<Song> getSongsForMood(String mood){
        return moodSongs.getOrDefault(mood,List.of(new Song("Default Vibe","mudic/happygirl.wav")));
    }
